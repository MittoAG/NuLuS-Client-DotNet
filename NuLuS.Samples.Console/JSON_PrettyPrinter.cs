...
namespace NuLuS.Samples.Console
{
    ...
    /// code by Mark Lakata
    /// 
    /// From topic 'How to set formatting with JavaScriptSerializer when JSON serializing?':
    /// http://stackoverflow.com/questions/5881204/how-to-set-formatting-with-javascriptserializer-when-json-serializing
    /// 
    /// </summary>
    public static class JSON_PrettyPrinter
    {
        public static string PrettyPrintJSON(this string inputText)
        {
            bool escaped = false;
            bool inquotes = false;
            int column = 0;
